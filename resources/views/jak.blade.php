...
<div class="container marketing">
	...
	<div class="card-group">
  		<div class="card text-center border-white">
  			<i class="material-icons" style="font-size:160px;color:rgb(150,150,150);">shopping_cart</i>
    		<div class="card-body">
  		...
  		<div class="card text-center border-white">
  			<i class="material-icons" style="font-size:160px;color:rgb(150,150,150);">forum</i>
    		<div class="card-body">
  		...
  		<div class="card text-center border-white">
    		<i class="material-icons" style="font-size:160px;color:rgb(150,150,150);">group_add</i>
    		<div class="card-body">
