...
<div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3 bg-light">
  <div class=" mr-md-3 pt-3  pt-md-5 text-center overflow-hidden bg-white">
    ...
    <img class="card-img-bottom card-product mx-auto" src="pic/m07.jpg" alt="Card image cap">
  </div>
  <div class=" mr-md-3 pt-3  pt-md-5 text-center overflow-hidden bg-white">
    <div class="my-3 py-3">
    ...
    <img class="card-img-bottom card-product mx-auto" src="pic/m09.jpg" alt="Card image cap">
  </div>
</div>
...
<div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3 bg-light">
  <div class=" mr-md-3 pt-3  pt-md-5 text-center overflow-hidden bg-white">
    ...
    <img class="card-img-bottom card-product mx-auto" src="pic/m10.jpg" alt="Card image cap">
  </div>
  <div class=" mr-md-3 pt-3  pt-md-5 text-center overflow-hidden bg-white">
    <div class="my-3 py-3">
    ...
    <img class="card-img-bottom card-product mx-auto" src="pic/m13.jpg" alt="Card image cap">
